...
class TestContentTypesInstalled(unittest.TestCase):
    ...
    def testInstalled(self):
        ...
        self.assertEquals(interfaces.IResearchLab, schema)

        factory = fti.factory
        new_object = createObject(factory)
        self.failUnless(interfaces.IResearchLab.providedBy(new_object))
    ...
    def testTraverseToSpecimen(self):
        ...
        institute1.invokeFactory('occams.lab.researchlab', 'lab1')
