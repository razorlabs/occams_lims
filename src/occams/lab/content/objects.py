...
#     # def createSpecimen(self, patient, cycle, date_collected):
#     #     """
...
#     #     kwargs['specimen_type'] = hasattr(self, 'type') and self.type or self.specimen_type
#     #     kwargs['location'] = self.destination
